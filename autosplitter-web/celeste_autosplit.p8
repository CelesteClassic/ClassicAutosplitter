...
function load_room(x,y)
  ...
  elseif lvl == 1 then
    cmd = 179
  elseif lvl<=31 and lvl>prev_room then
    cmd = 185
  ...
  if cmd != 0 then
    ...
    if cmd == 185 then
      ...
      printh("!"..timestr)
      for i=1,#timestr do
        poke(0x4302+i, ord(sub(timestr,i,i)))
      end
      poke(0x4303+#timestr, 0x0a)
      serial(0x805,0x4301, #timestr+3)
    else
      poke(0x4303, 0xa)
      serial(0x805, 0x4301, 3)
    end
  end
...
function _update()
  ...
  if frames==0 and level_index()<30 then
    ...
    for i=1,#timestr do
      poke(0x4301+i, ord(sub(timestr,i,i)))
    end
    poke(0x4302+#timestr, 0x0a)
    serial(0x805,0x4301, #timestr+2)
